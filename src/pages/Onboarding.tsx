      ...
      <Card className="p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input id="sector" placeholder="e.g., Manufacturing, Energy, Construction" />
              </div>
              <div>
                <Label htmlFor="contact">Contact Email</Label>
                <Input id="contact" type="email" placeholder="contact@company.com" />
              </div>
            </div>
          </div>
        )}
        ...
        {currentStep === 2 && (
          <div className="space-y-6">
            ...
            <p className="text-sm text-muted-foreground">Select the types of resources your company can provide or needs</p>
            <div className="space-y-3">
              {["Waste Heat", "Glass Scraps", "Wood Residues", "Used Oils", "Metal Waste", "Plastic Waste"].map(
                (resource) => (
                  <div key={resource} className="flex items-center space-x-2">
                    <Checkbox id={resource} />
